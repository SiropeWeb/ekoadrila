function botonEus() {
    ...
    jQuery(".y-yo").text("Ni nora noa?");
    jQuery(".cual").text("Zein da nire edukiontzia?");
    jQuery(".donde").text("Non utziko zenidake?");
    jQuery(".adivina").text("Asmatu nora noan.");
    jQuery(".hola").text("Kaixo, Lataburu Papelplatagaray naiz.");
    jQuery(".todos").text(
    ...
    jQuery(".aqui").text("Hemen Fraskobide Botellamendi.");
    jQuery(".mi").text(
    ...
    jQuery(".aupa").text("Aupa, Kajaguren Kartoiagoiti naiz.");
    jQuery(".espero").text(
    ...
    jQuery(".yo").text("Ni Detergenteberri Mantekillaga naiz.");
    jQuery(".al").text(
    ...
    jQuery(".ahora").text("Eta zuk, zenbat dakizu birziklatzeaz?");
    jQuery(".el-test").text(
        "“Behin betiko birziklatze-testa”. 6 galdera bakarrik."
    );
    jQuery(".tour").text("Hau izan da Ekoadrilaren bira!");
    jQuery(".informate").text(
        "Eskerrik asko parte hartu duzuen guztioi."
    );
    jQuery(".sigue").text("Jarraitu gure abenturak sareetan!");
    jQuery(".puedes").html(
    ...
    jQuery(".material").text("Prentsa materiala");
    jQuery(".dosier").text("Dosierra");
    jQuery(".aviso").text("Legezko oharra");
    jQuery(".cookies").text("Cookie politika");

    /*CUESTIONARIO */

    jQuery(".empezar").text("Hasi");
    jQuery(".respuesta").text("Erantzuna");
    jQuery(".siguiente-pregunta").text("Hurrengo galdera");

    jQuery(".terminar").text("Bukatu");
    jQuery(".enviar").text("Parte hartu");
    jQuery(".falta-respuesta").text("Zalantzak dituzu? Berdin dio! Aukeratu bat.");

    jQuery(".pregunta1").text(
        "Plastikozko jostailu bat, plastikozkoa denez, horira, ezta?"
    );
    jQuery(".pregunta1a").html(
        '<input type="radio" id="a1" name="pregunta1" value="a" />A. Noski. Plastikozkoa bada, edozer bota dezakezu.'
    );
    jQuery(".pregunta1b").html(
        '<input type="radio" id="b1" name="pregunta1" value="b" />B. Ez! Edukiontzi horira, ontziak bakarrik.</label>'
    );
    jQuery(".respuesta1a").text(
    ...
    jQuery(".pregunta3").text("Merezi al du birziklatzeko ahalegina egiteak?");
    jQuery(".pregunta3a").html(
        '<input type="radio" id="a3" name="pregunta3" value="a"/>A. Ez gehiegi. Azkenean ia hobe da produktu berriak egitea.'
    );
    jQuery(".pregunta3b").html(
    ...
    /* FORMULARIO EMAIL */
    jQuery(".enhorabuena").text("Zorionak! Amaieraraino iritsi zara");
    jQuery(".ya-solo").text(
    ...
    jQuery(".nombre").text("Izena eta abizena*");
    jQuery(".email").text("Emaila*");
    jQuery(".acepto").html(
        '<a href="/terminos-y-condiciones" target="_blank">Base legalak</a>* onartzen ditut'
    );

    jQuery(".revisa-campos").text("Datuak berrikusi formularioa bidali aurretik.");
    jQuery(".gracias").text("Eskerrik asko parte hartzeagatik!");
    jQuery(".el-sorteo").html(
        "Zozketa irailaren 2an egingo da.</br>Irabazlea bazara, zurekin harremanetan jarri ahal izango gara.</br>Zorte on!"
    );
    /*--------------------------------*/

    jQuery("#es").removeClass("bold");
    jQuery("#es").addClass("light");
    jQuery("#eu").removeClass("light");
    jQuery("#eu").addClass("bold");

    /* COOKIES*/
    jQuery(".politica-de-cookies").html(
...
function botonEs() {
    ...
    jQuery(".repasar").text("Repasar antes");
    jQuery(".hacer-test").text("Hacer test");
    jQuery(".antes").html(
    ...
    jQuery(".y-yo").text("¿Y yo dónde voy?");
    jQuery(".cual").text("¿Cuál es mi contenedor?");
    jQuery(".donde").text("¿Dónde me depositarías?");
    jQuery(".adivina").text("Adivina dónde voy.");
    jQuery(".hola").text("Hola, soy Lataburu Papelplatagaray.");
    jQuery(".todos").text(
    ...
    jQuery(".aqui").text("Aquí Fraskobide Botellamendi.");
    jQuery(".mi").text(
    ...
    jQuery(".aupa").text("Aupa, soy Kajaguren Kartoiagoiti.");
    jQuery(".espero").text(
    ...
    jQuery(".yo").text("Yo soy Detergenteberri Mantekillaga.");
    jQuery(".al").text(
    ...
    jQuery(".ahora").text("Y tú, ¿cuánto sabes de reciclaje?");
    jQuery(".el-test").text(
        "El “Test de Reciclaje Definitivo”. Tan solo 6 preguntas."
    );
    jQuery(".sigue").text("¡Sigue nuestras aventuras en las redes!");
    jQuery(".puedes").html(
    ...
    jQuery(".tour").text("¡Este ha sido el tour de la Ekoadrila!");
    jQuery(".informate").text(
        "Gracias por haberos acercado a participar."
    );
    jQuery(".material").text("Material prensa");
    jQuery(".dosier").text("Dosier");
    jQuery(".aviso").text("Aviso legal");
    jQuery(".cookies").text("Política de cookies");

    /*CUESTIONARIO */

    jQuery(".empezar").text("Empezar");
    jQuery(".respuesta").text("Respuesta");
    jQuery(".siguiente-pregunta").text("Siguiente pregunta");

    jQuery(".terminar").text("Terminar");
    jQuery(".enviar").text("Participar");
    jQuery(".falta-respuesta").text("¿Tienes dudas? ¡No importa! Elige una opción.");
    ...
    jQuery(".pregunta3").text("¿Merece la pena el esfuerzo de reciclar?");
    jQuery(".pregunta3a").html(
    ...
    jQuery(".pregunta5").text("¿La calidad de los productos reciclados es peor?");
    jQuery(".pregunta5a").html(
    ...
    jQuery(".pregunta6").text("¿Los aerosoles, se pueden reciclar?");
    jQuery(".pregunta6a").html(
    ...
    /* FORMULARIO EMAIL */
    jQuery(".enhorabuena").text("¡Enhorabuena! Has llegado hasta el final");
    jQuery(".ya-solo").text(
    ...
    jQuery(".nombre").text("Nombre y apellido*");
    jQuery(".email").text("Email*");
    jQuery(".acepto").html(
        'Acepto las <a href="/terminos-y-condiciones" target="_blank">bases legales</a>*'
    );

    jQuery(".revisa-campos").text("Revisa los campos antes de enviar el formulario.");

    jQuery(".gracias").text("¡Gracias por participar!");
    jQuery(".el-sorteo").html(
        "El sorteo se realizará el 2 de septiembre.</br>Si eres la persona ganadora, nos podremos en contacto contigo.</br>¡Suerte!"
    );
    /*--------------------------------*/

    jQuery("#eu").removeClass("bold");
    jQuery("#eu").addClass("light");
    jQuery("#es").removeClass("light");
    jQuery("#es").addClass("bold");
