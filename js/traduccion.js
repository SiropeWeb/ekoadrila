function botonEus() {
    ...
    $(".ahora").text("Eta zuk, zenbat dakizu birziklatzeaz?");
    $(".el-test").text(
        "“Behin betiko birziklatze-testa”. 6 galdera bakarrik."
    );
    $(".tour").text("Hau izan da Ekoadrilaren bira!");
    $(".informate").text(
    ...
    $(".respuesta1a").text(
        "A. O! Ez da zuzena. Jostailuek eta plastikozko produktuek, hondartzako ontziek adibidez, zalantza asko sortzen dituzte, baina gogoratu beti: edukiontzi horira, ontziak bakarrik. Besterik ez. Plastikozko eta metalezko ontziak, eta brikak. Baina ontziak bakarrik! Jarraitu galdeketarekin!"
    );
    $(".respuesta1b").text(
    ...
    $(".respuesta2a").text(
        "A. O! Zure erantzuna ez da zuzena. Berdera beirazko ontziak BAKARRIK! Beirazko potoak, beirazko botilak, beirazko flaskoak. Ez edalontzi, bonbila edo ispilurik. Eskerrik asko! Jarraitu galdeketarekin!"
    );
    $(".respuesta2b").text(
    ...
    $(".respuesta3a").text(
        "A. Zer diozu? Birziklatzen dugunean, ura, energia eta lehengaiak aurrezten ditugu. Gainera, lehengaiak egiteko prozesuan sortzen den kutsadura murrizten dugu. Noski merezi duela! Jarraitu galdeketarekin!"
    );
    $(".respuesta3b").text(
    ...
    $(".respuesta4b").text(
        "B. Ez da zuzena. Gogoratu beti: edukiontzi berdera, beirazko ontziak bakarrik: beirazko botilak, potoak eta flaskoak, estalkirik GABE. Jarraitu galdeketarekin!"
    );
    ...
    $(".respuesta5a").text(
        "A. Erantzun zuzena: Bai zera! Ontzi gehienetan, kalitatea mantendu egiten da birziklatu ahala. Beira, aluminioa eta plastiko asko mugarik gabe birzikla daitezke, kalitatea galdu gabe. Jarraitu galdeketarekin!"
    );
    $(".respuesta5b").text(
    ...
    $(".respuesta6b").text(
        "B. O! Ez duzu asmatu, baina galdera hau ez zen erraza. Etxean poltsa horia izan arren, biztanleriaren % 22k ez ditu edukiontzi horira botatzen, nora bota ez dakitelako. Aerosolak, horira!"
    );
...
function botonEs() {
    ...
    $(".ahora").text("Y tú, ¿cuánto sabes de reciclaje?");
    $(".el-test").text(
        "El “Test de Reciclaje Definitivo”. Tan solo 6 preguntas."
    );
    ...
    $(".tour").text("¡Este ha sido el tour de la Ekoadrila!");
    $(".informate").text(
        "Gracias por haberos acercado a participar."
    );
    ...
    $(".respuesta1a").text(
        "A. Oooh. No es correcto. Los juguetes y los productos de plástico como los cubos de playa, generan muchas dudas, pero recuerda siempre: al contenedor amarillo, solo envases. Nada más. Envases de plástico, de metal y briks. ¡Pero solo envases! ¡Sigue con la encuesta!"
    );
    $(".respuesta1b").text(
    ...
    $(".respuesta2a").text(
        "A. ¡Oooh! Tu respuesta no es correcta. ¡Al verde SOLO envases de vidrio! Tarros de vidrio, botellas de vidrio, frascos de vidrio. Nada de vasos, bombillas o espejos. ¡Gracias! ¡Sigue con la encuesta!"
    );
    $(".respuesta2b").text(
    ...
    $(".respuesta3a").text(
        "A. ¡Qué dices! Reciclando ahorramos agua, energía y materia prima. Además, reducimos la contaminación que se produce en el proceso de obtención de la materia prima. ¡Claro que merece la pena! ¡Sigue con la encuesta!"
    );
    $(".respuesta3b").text(
    ...
    $(".respuesta4b").text(
        "B. No es correcto. Recuerda siempre: al contenedor verde, solo envases de vidrio: botellas de vidrio, tarros y frascos de vidrio SIN sus respectivas tapas. ¡Sigue con la encuesta!"
    );
    ...
    $(".respuesta5a").text(
        "A. La respuesta correcta es… ¡qué va! En la mayoría de los envases, la calidad no va mermando reciclado a reciclado. Tanto el vidrio, como el aluminio y muchos plásticos pueden ser reciclados de forma ilimitada sin perder su calidad. ¡Sigue con la encuesta!"
    );
    $(".respuesta5b").text(
