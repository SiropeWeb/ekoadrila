function botonEus() {
    ...
    $(".sorteo-final2").text(
        "Pena handia ematen digu bidaia bukatzeak, baina oso pozik gaude lortu dugun guztiagatik. Eskerrik asko zuen konpromisoagatik!"
    );
...
function botonEs() {
    $(".cuando").html(
        '<span class="barra">/</span>Aunque nuestro viaje haya terminado,</br>¡sigamos trabajando!'
    );
    $(".sorteo").text(
